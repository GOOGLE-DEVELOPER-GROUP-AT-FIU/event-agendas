...
No. This hackathon is designed to be welcoming for first-time participants as well as experienced builders.
...
Projects will be evaluated based on brand fidelity, data precision, outreach effectiveness, scalability, and overall innovation. A fully coded product is not required, but teams should present a strong prototype or demo that clearly shows how the solution works.
...
Welcome to **DevFest + AI Hackathon — Spring 2026**.

This is a high-impact, one-day hackathon focused on building AI-powered solutions for real-world business challenges.

Participants will design intelligent systems that combine AI, automation, and product thinking to solve scaling problems in luxury markets, content generation, and business development.
...
| Category | Details |
|--------|---------|
| Event Type | One-day AI hackathon and innovation sprint |
| Focus Areas | AI • Automation • Content Generation • B2B Platforms |
...
| Event Info | Details |
|-----------|---------|
| 🎯 Theme | **AI • Luxury Growth • Automation • Product Development** |
...
| 🎁 Prize | --- |
| 🧑‍🏫 Mentorship | Available during build session |
| 🧾 Submission | Prototype + Demo + Presentation |
...
| 🗂 Eligibility | Must meet submission requirements |
| ⚠️ Disclaimer | Subject to organizer availability |
...
<details>
<summary><strong>FAM Friday — Spring Forward: Access to Opportunities</strong></summary>
...
| Time (EDT) | Activity | Details | Location |
|-----------|----------|---------|----------|
| 01:00 PM | Welcome & Announcements | Spring Forward: Access to Opportunities kickoff | In-Person / Zoom |
| 01:30 PM | Session 1 | Crack the Code: Tech Recruiting 101 with Cristian Castro-Oliva, Daniela Perez, Courtney Naughton | In-Person / Zoom |
| 02:15 PM | Session 2 | Finding Your Way in Tech: Building Your Career and Standing Out in the Agentic Era with Eduardo Mares and Payton McGranahan | In-Person / Zoom |
| 03:00 PM | Session 3 | Leveraging AI to Shape Your Career with Jordan Kail | In-Person / Zoom |
...
| 🏫 Location | Florida International University (PG6) + Zoom |
| 🎯 Focus | Career Growth • Tech Recruiting • AI Careers |
...
*Prompt* : https://docs.google.com/document/d/1F54U8C8g7BmQPEOuStDV9xYsKUE2JmIOTKVFeQS2RAw/edit?usp=sharing

*Hack Resources* : https://docs.google.com/document/d/1VFh4zv4siHY4oQm1A71BngMpY3ZGxxzPBTj-wAmmYv4/edit?usp=sharing 
...
Make sure your project is complete and ready before submission.
...
- **Presentation Slides**
- **Github link**
- **Submission through Devpost**

---

### ⭐ What Makes a Strong Submission

- Clear AI-driven solution  
- Strong prototype or demo  
- High-quality idea execution  
- Alignment with luxury brand requirements  
...
This hackathon is designed to push participants to build real AI-powered solutions that solve complex business problems.

Participants will collaborate, prototype, and present solutions that demonstrate how AI can scale luxury experiences without losing personalization.

**Build fast. Think big. Execute smart.**
